    ...
    def __init__(
        ...
        **kwargs
        ...
        if encoder_decoder_type in ["bart", "marian", "blender", "blender-large"]:
            ...
            #     self.encoder_tokenizer = tokenizer_class.from_pretrained(encoder_decoder_name, additional_special_tokens=['Location', 'Aquifer_type', 'Groundwater_type','Hydrochemical_type',
            #   'Rock_type', 'Stratigraphic_group_type', 'Geologic_age'])
